...
sys.path.insert(0, '/Site/scipy16/SciPy2017/scipy2017')
sys.path.insert(1, '/Site/scipy16/SciPy2017')
sys.path.insert(2, '/Site/scipy16/scipy_env/lib/python2.7/site-packages')
# We defer to a DJANGO_SETTINGS_MODULE already in the environment. This breaks
# if running multiple sites in the same mod_wsgi process. To fix this, use
# mod_wsgi daemon mode with each site in its own daemon process, or use

os.environ.setdefault("DJANGO_SETTINGS_MODULE", "scipy2017.settings")
